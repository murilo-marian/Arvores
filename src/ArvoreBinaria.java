...
public class ArvoreBinaria {
    ...
    public void removerImperativo(int chave) {
        if (raiz == null) {
            return;
        }
        ...
        while (nodoAtual != null && nodoAtual.chave != chave) {
        ...
        if (nodoAtual.esq == null && nodoAtual.dir == null) {
            ...
            if (paiNodo == null) {
                ...
                paiNodo.esq = nodoAtual.dir;
            } else {
                paiNodo.dir = nodoAtual.dir;
            }
        } else if (nodoAtual.dir == null) {
            if (paiNodo == null) {
                raiz = nodoAtual.esq;
            } else if (paiNodo.esq == nodoAtual) {
                paiNodo.esq = nodoAtual.esq;
            } else {
                paiNodo.dir = nodoAtual.esq;
            }
        }
        else {
            Nodo sucessor = encontrarSucessor(nodoAtual.dir);
            nodoAtual.chave = sucessor.chave;
            nodoAtual.dir = removerMenorNodo(nodoAtual.dir);
        }
    }

    private Nodo removerMenorNodo(Nodo nodo) {
        if (nodo == null) {
            return null;
        }
    ...
    private void mostrarNormal(Nodo raiz) {
        if (raiz != null) {
            ...
            if (raiz.esq != null) {
                System.out.println("Filho esquerda: " + raiz.esq.chave);
            }
            if (raiz.dir != null) {
                System.out.println("Filho direita: " + raiz.dir.chave);
            }
            System.out.println("-");
